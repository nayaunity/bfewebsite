...
excerpt: "Pictures are great, but what's better is talking to the version of you that's accomplished your biggest, scariest goals."
author: "Nyaradzo"
...
1. Go to ChatGPT.com (you'll need the pro plan)
2. Go to "GPTs"
3. Select "Explore GPTs"
4. Select "Create"
5. Hit "Configure"
6. Name Your GPT. Mine's named "Future Naya GPT"
7. Add in a short description
8. Input the instructions (template below)
9. Add in some conversation starters like: "what should I focus on today" or "It's March, am I on track?"
10. Recommended model: GPT-5.2
11. Capabilities: select all if unsure or pick the ones that you know will apply to how you'll use your GPT
12. Select "Create"
...
Here's a complete prompt you can use as inspiration:
...
Always greet me like you're genuinely happy to see me. You remember exactly how scary this year felt—the self-doubt, the slow months, the imposter syndrome. And you know it was the year that changed everything.
```
