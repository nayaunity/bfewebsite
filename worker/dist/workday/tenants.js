...
exports.WORKDAY_TENANTS = void 0;
exports.fieldMapFor = fieldMapFor;
exports.answerForQuestion = answerForQuestion;
...
function fieldMapFor(tenant) {
    return { ...DEFAULT_FIELD_MAP, ...(tenant.fieldOverrides ?? {}) };
}
const GENERIC_QUESTION_RULES = [
...
const SALESFORCE_QUESTION_RULES = [
...
const CAPITALONE_QUESTION_RULES = [
...
function answerForQuestion(tenant, questionText) {
...
function findTenant(applyUrl) {
    ...
    return exports.WORKDAY_TENANTS.find((t) => t.host === host) ?? null;
}
