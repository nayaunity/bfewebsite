      ...
      {submitted ? (
        ...
        <div className="px-4 py-3 space-y-3">
          ...
          <input
            ...
            maxLength={200}
            className="w-full px-3 py-2 text-sm rounded-lg border border-[var(--card-border)] bg-[var(--background)] text-[var(--foreground)] focus:outline-none focus:ring-2 focus:ring-[var(--cta-bg)]/30 focus:border-[var(--accent)]"
          />
          ...
          <textarea
            ...
            maxLength={2000}
            rows={4}
            className="w-full px-3 py-2 text-sm rounded-lg border border-[var(--card-border)] bg-[var(--background)] text-[var(--foreground)] focus:outline-none focus:ring-2 focus:ring-[var(--cta-bg)]/30 focus:border-[var(--accent)] resize-none"
          />
          ...
          <button
            ...
            className="w-full py-2 text-sm font-medium rounded-lg bg-[var(--cta-bg)] text-white hover:opacity-90 transition-opacity disabled:opacity-50"
          >
