...
export function ResumeQuiz({ firstName }: { firstName: string | null }) {
    ...
    return (
      <div className="min-h-[60vh] flex items-center justify-center">
        <div className="text-center max-w-md">
          <div className="w-16 h-16 mx-auto mb-6 rounded-full bg-[var(--cta-bg)]/10 flex items-center justify-center">
            <svg
    ...
    return (
      <div className="min-h-[60vh] flex items-center justify-center">
        <div className="text-center max-w-md">
          ...
          <Link
            href="/profile"
            className="inline-flex items-center gap-2 px-6 py-3 bg-[var(--cta-bg)] text-white rounded-xl hover:bg-[#d44a22] transition-colors font-medium"
          >
            Back to Dashboard
          </Link>
        </div>
  ...
  if (phase === "upgrade") {
    return (
      <div className="min-h-[60vh] flex items-center justify-center">
        <div className="text-center max-w-md">
          <div className="w-20 h-20 mx-auto mb-6 rounded-full bg-[var(--cta-bg)]/10 flex items-center justify-center">
            <svg
    ...
    <div className="max-w-2xl mx-auto">
      ...
      <div className="bg-[var(--card-bg)] border border-[var(--card-border)] rounded-2xl p-8">
        <div className="flex items-center gap-3 mb-4">
          <span className="flex-shrink-0 w-8 h-8 rounded-full bg-[var(--cta-bg)] text-white flex items-center justify-center text-sm font-bold">
            {q.number}
          </span>
        ...
        <textarea
          ...
          rows={4}
          className="w-full px-4 py-3 text-sm rounded-xl border border-[var(--card-border)] bg-[var(--background)] text-[var(--foreground)] placeholder:text-[var(--gray-600)]/50 focus:outline-none focus:ring-2 focus:ring-[var(--cta-bg)]/30 focus:border-[var(--accent)] resize-none transition-all"
          autoFocus
          onKeyDown={(e) => {
        ...
        <div className="flex items-center gap-2">
          ...
          {isLast ? (
            <button
              ...
              className="flex items-center gap-2 px-6 py-2.5 bg-[var(--cta-bg)] text-white rounded-xl hover:bg-[#d44a22] disabled:opacity-50 disabled:cursor-not-allowed transition-all font-medium text-sm"
            >
              {phase === "submitting" ? (
                <>
                  <svg
