        ...
        <section className="pb-16 md:pb-24">
          <div className="max-w-3xl mx-auto px-4 sm:px-6 lg:px-8">
            ...
            <div className="prose prose-lg max-w-none space-y-8">
              ...
              <section>
                <h2 className="font-serif text-2xl mb-4">Description of Services</h2>
                <p className="text-[var(--gray-600)] leading-relaxed">
              ...
              <section>
                <h2 className="font-serif text-2xl mb-4">User Accounts</h2>
              ...
              <section>
                <h2 className="font-serif text-2xl mb-4">User Content</h2>
                <p className="text-[var(--gray-600)] leading-relaxed">
              ...
              <section>
                <h2 className="font-serif text-2xl mb-4">Job Board</h2>
                <p className="text-[var(--gray-600)] leading-relaxed">
              ...
              <section>
                <h2 className="font-serif text-2xl mb-4">Indemnification</h2>
                <p className="text-[var(--gray-600)] leading-relaxed">
