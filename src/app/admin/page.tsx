              ...
              {stats.users.map((user) => (
                ...
                >
                  <div className="flex items-center gap-3 min-w-0">
                    <div className="flex-shrink-0 w-8 h-8 rounded-full bg-[var(--gray-100)] flex items-center justify-center">
                  ...
                  <div className="flex-shrink-0 ml-2">
                    {user.emailVerified ? (
                      ...
                      <span className="inline-flex items-center px-2 py-0.5 rounded-full text-xs font-medium bg-[var(--gray-100)] text-[var(--gray-600)]">
                        Pending
                      </span>
                    )}
                  </div>
