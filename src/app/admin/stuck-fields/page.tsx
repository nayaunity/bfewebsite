        ...
        <div className="flex items-center justify-between mb-8">
          <div>
            <h1 className="font-serif text-3xl text-[var(--foreground)]">
              Stuck <span className="italic text-[var(--accent)]">fields</span>
            </h1>
              ...
              {top.map((row, i) => (
                <tr key={i} className="border-t border-[var(--card-border)]">
                  ...
                  <td className="px-4 py-2">
                    <a href={row.samplePageUrl} target="_blank" rel="noreferrer" className="text-[var(--accent)] hover:underline truncate inline-block max-w-xs">
