                  ...
                  <div
                    ...
                    className={`bg-[var(--background)] border rounded-xl p-3 hover:shadow-md transition-all cursor-pointer ${
                      selectedTicket?.id === ticket.id
                        ? "border-[var(--accent)] ring-1 ring-[var(--cta-bg)]/30"
            ...
            <div className="px-6 py-5 space-y-5">
              ...
              <div>
                ...
                <div className="flex items-center gap-3">
                  <div className="w-8 h-8 rounded-full bg-[var(--cta-bg)] flex items-center justify-center text-white text-xs font-bold">
