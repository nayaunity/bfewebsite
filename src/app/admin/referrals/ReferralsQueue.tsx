              ...
              >
                <div className="flex items-start justify-between gap-3">
                  ...
                  <div className="text-right">
                    <p className="text-xs font-medium text-[#ef562a]">P{request.priority}</p>
          ...
          <div className="space-y-5">
            ...
            <div className="grid gap-4 md:grid-cols-2">
              ...
              <div className="rounded-2xl bg-[var(--gray-50)] p-4">
                ...
                <a href={selected.connection.profileUrl} target="_blank" rel="noreferrer" className="mt-2 inline-block text-xs text-[#ef562a] hover:underline">
