      ...
      <div className="max-w-5xl mx-auto px-4 pb-20">
        ...
        <div className="text-center mb-16">
          <h1 className="font-serif text-4xl md:text-5xl text-[var(--foreground)] mb-4">
            Auto-Apply for <span className="italic text-[var(--accent)]">Volume</span>.{" "}
            {showReferrals ? (
              <>Use Referrals for <span className="italic text-[var(--accent)]">Signal</span>.</>
            ) : (
              <>Tailor for <span className="italic text-[var(--accent)]">Fit</span>.</>
            )}
          </h1>
