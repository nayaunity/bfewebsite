...
export function CountdownBar() {
  ...
  return (
    <div className="fixed top-0 left-0 right-0 z-[9999] bg-[var(--cta-bg)] text-white py-3 px-4 text-center">
      <div className="max-w-7xl mx-auto flex items-center justify-center gap-3 sm:gap-6 font-serif text-base sm:text-lg tracking-wide">
        <span className="inline-block w-2.5 h-2.5 rounded-full bg-[var(--cta-bg)] animate-pulse" />
    ...
    <div className="flex flex-col sm:flex-row items-start sm:items-center gap-3 text-sm">
      {!expired && (
        <div className="flex items-center gap-2">
          <span className="inline-block w-2 h-2 rounded-full bg-[var(--cta-bg)] animate-pulse" />
