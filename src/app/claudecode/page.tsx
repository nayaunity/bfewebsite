...
const deliverables = [
  {
    ...
    description:
      "Real AI-powered apps you build, deploy, and can demo in interviews.",
  },
  {
    icon: (
      <svg className="w-8 h-8" fill="none" stroke="currentColor" strokeWidth={1.5} viewBox="0 0 24 24">
    ...
    description:
      "Join a community of career switchers building with Claude Code together.",
  },
  {
    icon: (
      <svg className="w-8 h-8" fill="none" stroke="currentColor" strokeWidth={1.5} viewBox="0 0 24 24">
    ...
    <>
      ...
      <JsonLd
        data={{
          ...
          description:
            "The first structured Claude Code course for career switchers. 6 modules and 3 deployed portfolio projects.",
          provider: {
            "@type": "Organization",
          ...
          <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 text-center">
            ...
            <div className="space-y-8 text-left max-w-2xl mx-auto">
              {[
                ...
                "This course gives you the portfolio project and the hands-on skills to prove you belong in the room.",
              ].map((item, i) => (
          ...
          <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
            ...
            <div className="grid md:grid-cols-2 gap-8 max-w-5xl mx-auto">
              {deliverables.map((item, i) => (
                ...
                >
                  <div className="w-14 h-14 rounded-full bg-[var(--cta-bg)] flex items-center justify-center text-white mb-4">
                    {item.icon}
                  </div>
          ...
          <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
            ...
            <div className="max-w-lg mx-auto">
              <div className="bg-[var(--card-bg)] border-2 border-[var(--accent)] rounded-2xl p-8 md:p-10 relative text-center">
                ...
                <EnrollCTA className="inline-flex items-center justify-center gap-2 bg-[var(--cta-bg)] text-white px-8 py-4 rounded-full font-medium hover:bg-[var(--accent-hover)] transition-colors text-lg w-full" />
