        ...
        <section className="pb-16 md:pb-24">
          <div className="max-w-3xl mx-auto px-4 sm:px-6 lg:px-8">
            ...
            <div className="prose prose-lg max-w-none space-y-8">
              <section>
                <h2 className="font-serif text-2xl mb-4 text-[var(--foreground)]">Introduction</h2>
              ...
              <section>
                <h2 className="font-serif text-2xl mb-4 text-[var(--foreground)]">Information We Collect</h2>
                <p className="text-[var(--gray-600)] leading-relaxed mb-4">
                  We may collect the following types of information:
                </p>
                <ul className="list-disc pl-6 text-[var(--gray-600)] space-y-2">
                  <li><strong className="text-[var(--foreground)]">Account Information:</strong> When you sign up, we collect your email address and display name.</li>
                  <li><strong className="text-[var(--foreground)]">Usage Data:</strong> We collect information about how you interact with our platform, including pages visited, lessons completed, and features used.</li>
                  <li><strong className="text-[var(--foreground)]">Analytics Data:</strong> We use analytics tools to understand how our platform is used and to improve our services.</li>
                  <li><strong className="text-[var(--foreground)]">Communications:</strong> If you contact us or subscribe to our newsletter, we collect the information you provide.</li>
                </ul>
              </section>

              <section>
                <h2 className="font-serif text-2xl mb-4 text-[var(--foreground)]">How We Use Your Information</h2>
                <p className="text-[var(--gray-600)] leading-relaxed mb-4">
              ...
              <section>
                <h2 className="font-serif text-2xl mb-4 text-[var(--foreground)]">Data Sharing</h2>
                <p className="text-[var(--gray-600)] leading-relaxed">
              ...
              <section>
                <h2 className="font-serif text-2xl mb-4 text-[var(--foreground)]">Cookies and Tracking</h2>
                <p className="text-[var(--gray-600)] leading-relaxed">
              ...
              <section>
                <h2 className="font-serif text-2xl mb-4 text-[var(--foreground)]">Data Security</h2>
                <p className="text-[var(--gray-600)] leading-relaxed">
              ...
              <section>
                <h2 className="font-serif text-2xl mb-4 text-[var(--foreground)]">Your Rights</h2>
                <p className="text-[var(--gray-600)] leading-relaxed mb-4">
              ...
              <section>
                <h2 className="font-serif text-2xl mb-4 text-[var(--foreground)]">Third-Party Links</h2>
                <p className="text-[var(--gray-600)] leading-relaxed">
              ...
              <section>
                <h2 className="font-serif text-2xl mb-4 text-[var(--foreground)]">Changes to This Policy</h2>
                <p className="text-[var(--gray-600)] leading-relaxed">
