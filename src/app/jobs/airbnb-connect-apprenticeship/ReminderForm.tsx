...
export default function ReminderForm() {
  ...
  const handleSubmit = async (e: React.FormEvent) => {
    ...
    await subscribe(email, {
      tags: ["bfewebsite", "airbnb-connect-reminder-2026"],
      onSuccess: () => setEmail(""),
    });
  };
      ...
      <div className="p-6 md:p-8 bg-[#ffe500]/50 border border-[#ffe500] rounded-2xl">
        <div className="flex items-start gap-4 mb-4">
          ...
          <div>
            ...
            <p className="text-[var(--gray-600)] text-sm">
              I&apos;ll send you a reminder the day before and the morning of April 6th so you don&apos;t miss the application window.
            </p>
          </div>
        </div>
        ...
        {isSuccess ? (
          <div className="p-4 bg-green-500/20 text-green-700 dark:text-green-300 rounded-lg text-center">
            ...
            <p className="text-sm mt-1 opacity-80">You&apos;ll hear from me on April 5th and 6th!</p>
          </div>
        ) : (
