          ...
          <div className="space-y-10">
            ...
            <section>
              ...
              <ul className="space-y-3">
                <li className="flex items-start gap-3 text-[var(--foreground)]">
                  <span className="flex-shrink-0 w-6 h-6 rounded-full bg-[var(--cta-bg)] flex items-center justify-center text-white text-sm font-bold">1</span>
                  <span><strong>Career changers:</strong> You&apos;re transitioning into tech from another field</span>
                </li>
                <li className="flex items-start gap-3 text-[var(--foreground)]">
                  <span className="flex-shrink-0 w-6 h-6 rounded-full bg-[var(--cta-bg)] flex items-center justify-center text-white text-sm font-bold">2</span>
                  <span><strong>Self-taught developers:</strong> You&apos;ve learned to code on your own and want structured experience</span>
                </li>
                <li className="flex items-start gap-3 text-[var(--foreground)]">
                  <span className="flex-shrink-0 w-6 h-6 rounded-full bg-[var(--cta-bg)] flex items-center justify-center text-white text-sm font-bold">3</span>
                  <span><strong>Bootcamp graduates:</strong> You&apos;ve completed a coding bootcamp and want enterprise experience</span>
                </li>
                <li className="flex items-start gap-3 text-[var(--foreground)]">
                  <span className="flex-shrink-0 w-6 h-6 rounded-full bg-[var(--cta-bg)] flex items-center justify-center text-white text-sm font-bold">4</span>
            ...
            <section>
              ...
              <div className="space-y-4">
                ...
                <div className="flex items-start gap-4 p-4 bg-[var(--card-bg)] border border-[var(--card-border)] rounded-xl">
                  <span className="flex-shrink-0 w-8 h-8 rounded-full bg-[var(--cta-bg)] flex items-center justify-center text-white font-bold">4</span>
                  <div>
