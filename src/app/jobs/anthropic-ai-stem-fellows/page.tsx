          ...
          <div className="space-y-10">
            ...
            <section>
              ...
              <ul className="space-y-3">
                ...
                <li className="flex items-start gap-3 text-[var(--foreground)]">
                  <span className="flex-shrink-0 w-6 h-6 rounded-full bg-[var(--cta-bg)] flex items-center justify-center text-white text-sm font-bold">5</span>
            ...
            <section>
              ...
              <div className="p-6 bg-[var(--cta-bg)]/10 border border-[var(--accent)] rounded-xl">
                <div className="flex items-center gap-4">
                  <div className="w-16 h-16 rounded-full bg-[var(--cta-bg)] flex items-center justify-center">
