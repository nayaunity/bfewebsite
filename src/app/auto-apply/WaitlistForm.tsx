    ...
    <div className="max-w-xl mx-auto">
      <form onSubmit={handleSubmit} className="flex flex-col sm:flex-row gap-3">
        <input
          ...
          required
          disabled={isLoading}
          className="flex-1 px-5 py-4 bg-[var(--background)] border-2 border-[var(--card-border)] text-[var(--foreground)] placeholder-[var(--gray-600)] rounded-xl text-lg focus:outline-none focus:ring-2 focus:ring-[var(--cta-bg)]/50 focus:border-[var(--accent)] disabled:opacity-50"
        />
        <button
          type="submit"
          disabled={isLoading}
          className="bg-[var(--cta-bg)] text-white px-8 py-4 rounded-xl font-semibold text-lg hover:bg-[#d94a24] transition-colors disabled:opacity-50 whitespace-nowrap"
        >
