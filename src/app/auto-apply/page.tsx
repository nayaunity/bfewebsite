      ...
      <main className="min-h-screen bg-[var(--background)]">
        ...
        <section className="pt-44 pb-16 px-6">
          <div className="max-w-3xl mx-auto text-center">
            <span className="inline-block px-4 py-1.5 bg-[var(--cta-bg)]/10 text-[var(--accent)] text-sm font-semibold rounded-full mb-6">
              COMING SOON
            </span>
          ...
          <div className="max-w-4xl mx-auto">
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
              {features.map((feature) => (
                ...
                >
                  <div className="w-12 h-12 rounded-xl bg-[var(--cta-bg)]/10 text-[var(--accent)] flex items-center justify-center mb-4">
                    {feature.icon}
                  </div>
