...
export async function generateMetadata({ params }: PageProps) {
  ...
  return {
    title: `${lessonInfo.lesson.title} | GitHub Essentials | The Black Female Engineer`,
    description: `Learn about ${lessonInfo.lesson.title} in this comprehensive guide to optimizing your GitHub profile for recruiters.`,
  };
}
