...
export const metadata = {
  title: "GitHub Essentials | The Black Female Engineer",
  description:
    "Optimize your GitHub for recruiters, not developers. Learn how to structure your repositories, write compelling READMEs, and showcase your skills in a way that lands interviews.",
};

export default function GitHubEssentialsPage() {
  const course = getCourse("github-essentials");
  if (!course) notFound();
  ...
  return (
    <>
      ...
      <main className="pt-28 md:pt-32">
                ...
                <div className="space-y-6">
                  {course.modules.map((module) => (
                    ...
                    >
                      ...
                      <ModuleLessons module={module} coursePath="/resources/github-essentials" courseId="github-essentials" />
                    </div>
                  ))}
                </div>
              </div>
        ...
        {/* Email Gate Preview */}
        <EmailGateSection totalLessons={course.stats.lessons} courseTag="github-essentials-guide" />
      </main>
      <Footer />
    </>
  );
