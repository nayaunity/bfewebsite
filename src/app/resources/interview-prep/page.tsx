...
export const metadata = {
  title: "Interview Prep | The Black Female Engineer",
  description:
    "Master the tech interview process from application to offer. Learn what recruiters look for, ace technical and behavioral interviews, and negotiate the best compensation package.",
};

export default function InterviewPrepPage() {
  const course = getCourse("interview-prep");
  if (!course) notFound();
  ...
  return (
    <>
      ...
      <main className="pt-28 md:pt-32">
          ...
          <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
            ...
            <div className="grid lg:grid-cols-3 gap-8 items-start">
              ...
              <div className="bg-[var(--card-bg)] rounded-2xl border border-[var(--card-border)] p-6 shadow-sm">
                ...
                {firstLesson && (
                  <Link
                    href={`/resources/interview-prep/${firstLesson.slug}`}
                ...
                <div className="space-y-6">
                  {course.modules.map((module) => (
                    ...
                    >
                      ...
                      <ModuleLessons module={module} coursePath="/resources/interview-prep" courseId="interview-prep" />
                    </div>
                  ))}
                </div>
              </div>
        ...
        {/* Email Gate Preview */}
        <EmailGateSection totalLessons={course.stats.lessons} courseTag="interview-prep-guide" />
      </main>
      <Footer />
    </>
  );
