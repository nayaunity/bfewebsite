...
export const metadata = {
  title: "Break Into Tech | The Black Female Engineer",
  description:
    "Your guide to transitioning into software engineering. Learn strategies for portfolio projects, social presence, resumes, and landing your first tech role.",
};
  ...
  return (
    <>
      ...
      <main className="pt-28 md:pt-32">
        {/* Hero */}
        <section className="bg-gradient-to-b from-yellow-50 to-white py-12 md:py-16 border-b border-gray-100">
          <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
            <div className="flex items-center gap-2 text-sm text-gray-500 mb-4">
              ...
              <span>/</span>
              <span>Break Into Tech</span>
            </div>

            <div className="grid lg:grid-cols-3 gap-8 items-start">
              <div className="lg:col-span-2">
                <span className="inline-block text-xs px-3 py-1 rounded-full font-medium bg-yellow-100 text-yellow-800 mb-4">
                  {course.tag}
                </span>
              ...
              <div className="bg-white rounded-2xl border border-gray-200 p-6 shadow-sm">
                  ...
                  {course.features.map((feature, index) => (
                    <div key={index} className="flex items-center gap-3 text-sm">
                      <div className={`w-8 h-8 rounded-full flex items-center justify-center ${
                        index === 0 ? "bg-green-100" : index === 1 ? "bg-yellow-100" : "bg-orange-100"
                      }`}>
                        <svg className={`w-4 h-4 ${
                          index === 0 ? "text-green-600" : index === 1 ? "text-yellow-600" : "text-orange-600"
                ...
                {firstLesson && (
                  <Link
                    href={`/resources/break-into-tech/${firstLesson.slug}`}
                ...
                <div className="space-y-6">
                  {course.modules.map((module) => (
                    ...
                    >
                      ...
                      <ModuleLessons module={module} coursePath="/resources/break-into-tech" courseId="break-into-tech" />
                    </div>
                  ))}
                </div>
              </div>
        ...
        <section className="bg-gray-50 py-16 md:py-24 border-t border-gray-100">
          <div className="max-w-2xl mx-auto px-4 sm:px-6 lg:px-8 text-center">
            ...
            <p className="text-gray-600 mb-8">
              Get access to all {course.stats.lessons} lessons, including advanced networking strategies
              and interview preparation. Just enter your email to continue.
            </p>
