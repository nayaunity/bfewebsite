    ...
    return (
      <div className="bg-[var(--card-bg)] border border-[var(--card-border)] rounded-2xl p-5 sm:p-6 mb-8">
        <div className="flex flex-col sm:flex-row sm:items-center sm:justify-between gap-4">
          ...
          <Link
            href="/auth/signin?callbackUrl=/resources/gaining-experience"
            className="px-5 py-2.5 bg-[var(--cta-bg)] text-white rounded-full font-medium hover:bg-[#d94d25] transition-colors text-sm text-center shrink-0"
          >
            Sign In
          </Link>
        </div>
