...
export const metadata = {
  title: "Gaining Experience Without Experience | The Black Female Engineer",
  description:
    "Build a hireable portfolio from scratch. Learn how to gain real-world skills through projects, open source, hackathons, and more.",
};

export default function GainingExperiencePage() {
  const course = getCourse("gaining-experience");
  if (!course) notFound();
                ...
                <div className="space-y-6">
                  {course.modules.map((module) => (
                    ...
                    >
                      ...
                      <ModuleLessons module={module} coursePath="/resources/gaining-experience" courseId="gaining-experience" />
                    </div>
                  ))}
                </div>
              </div>
        ...
        <section className="bg-[var(--gray-50)] py-16 md:py-24 border-t border-[var(--card-border)]">
          <div className="max-w-2xl mx-auto px-4 sm:px-6 lg:px-8 text-center">
            ...
            <p className="text-[var(--gray-600)] mb-8">
              ...
              for building experience through open source, hackathons, and more. Just enter your email to continue.
            </p>
