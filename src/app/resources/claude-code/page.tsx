  ...
  return (
    <>
      ...
      <main className="pt-28 md:pt-32">
          ...
          <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
            ...
            <div className="grid lg:grid-cols-3 gap-8 items-start">
              ...
              <div className="bg-[var(--card-bg)] rounded-2xl border border-[var(--card-border)] p-6 shadow-sm">
                  ...
                  {course.features.map((feature, index) => (
                    <div key={index} className="flex items-center gap-3 text-sm">
                      <div className={`w-8 h-8 rounded-full flex items-center justify-center ${
                        index === 0 ? "bg-[var(--accent-green-bg)]" : index === 1 ? "bg-[var(--accent-purple-bg)]" : "bg-[var(--accent-purple-bg)]"
                      }`}>
                        <svg className={`w-4 h-4 ${
                          index === 0 ? "text-[var(--accent-green-text)]" : index === 1 ? "text-[var(--accent-purple-text)]" : "text-[var(--accent-purple-text)]"
                ...
                {firstLesson && (
                  <Link
                    href={`/resources/claude-code/${firstLesson.slug}`}
        ...
        {/* Email Gate Preview */}
        <EmailGateSection totalLessons={course.stats.lessons} courseTag="claude-code-guide" />
      </main>
      <Footer />
    </>
  );
