  ...
  return (
    <>
      ...
      <main className="pt-28 md:pt-32">
        {/* Hero */}
        <section className="bg-gradient-to-b from-purple-50 to-white py-12 md:py-16 border-b border-gray-100">
                  ...
                  {course.features.map((feature, index) => (
                    <div key={index} className="flex items-center gap-3 text-sm">
                      <div className={`w-8 h-8 rounded-full flex items-center justify-center ${
                        index === 0 ? "bg-green-100" : index === 1 ? "bg-purple-100" : "bg-purple-100"
                      }`}>
                        <svg className={`w-4 h-4 ${
                          index === 0 ? "text-green-600" : index === 1 ? "text-purple-600" : "text-purple-600"
