      ...
      <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        <div className="text-center mb-8">
          ...
          <h2 className="font-serif text-3xl md:text-4xl mb-3">
            Watch the Full <span className="italic text-[var(--accent)]">Workshop</span>
          </h2>
          ...
          <a
            ...
            className="inline-block mt-4 text-xl md:text-2xl font-serif text-[var(--accent)] hover:text-[#d44a22] transition-colors underline underline-offset-4"
          >
          ...
          <div className="relative">
                ...
                <form onSubmit={handleUnlock} className="w-full max-w-md">
                  <div className="flex flex-col gap-3">
                    <input
                      ...
                      className="w-full px-5 py-4 rounded-full bg-white/10 backdrop-blur-sm border border-white/20 text-white placeholder-white/50 focus:outline-none focus:border-[var(--accent)] disabled:opacity-50"
                    />
                    <button
                      type="submit"
                      disabled={isSubmitting}
            ...
            <div className="flex flex-wrap justify-center gap-2 md:gap-3 mt-4 md:mt-6">
              <span className="inline-flex items-center gap-1.5 text-xs md:text-sm px-3 md:px-4 py-1.5 md:py-2 rounded-full bg-[var(--card-bg)] border border-[var(--card-border)]">
                <svg className="w-3.5 h-3.5 md:w-4 md:h-4 text-[var(--accent)]" fill="none" stroke="currentColor" viewBox="0 0 24 24">
