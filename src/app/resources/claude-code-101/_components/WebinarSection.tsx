        ...
        {hasAccess ? (
          ...
          <div className="relative">
            ...
            <div className="relative rounded-2xl overflow-hidden shadow-2xl">
              {/* YouTube Thumbnail */}
              <div className="aspect-video bg-[var(--gray-900)] relative">
                <img
                ...
                <div className="absolute inset-0 flex flex-col items-center justify-center p-6 text-center">
                  ...
                  <h3 className="text-white text-2xl md:text-3xl font-serif mb-3">
                    Unlock the Webinar
                  </h3>
                  ...
                  <form onSubmit={handleUnlock} className="w-full max-w-md">
                    <div className="flex flex-col sm:flex-row gap-3">
                      <input
                        ...
                        className="flex-1 px-5 py-4 rounded-full bg-white/10 backdrop-blur-sm border border-white/20 text-white placeholder-white/50 focus:outline-none focus:border-[#ffe500] disabled:opacity-50"
                      />
                      <button
                        type="submit"
                        disabled={isSubmitting}
            ...
            <div className="flex flex-wrap justify-center gap-3 mt-6">
              <span className="inline-flex items-center gap-1.5 text-sm px-4 py-2 rounded-full bg-[var(--card-bg)] border border-[var(--card-border)]">
