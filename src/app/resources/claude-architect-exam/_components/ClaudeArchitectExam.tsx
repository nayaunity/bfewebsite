      ...
      <div className="p-8 max-w-[720px] mx-auto bg-[var(--card-bg)] rounded-2xl border border-[var(--card-border)] text-[var(--foreground)]">
        <div className="border-b border-[var(--card-border)] pb-6 mb-6">
          <div className="flex items-center gap-2.5 mb-2">
            <div className="w-9 h-9 rounded-lg bg-[var(--cta-bg)] flex items-center justify-center text-white text-[15px] font-semibold">
              C
            </div>
        ...
        <button
          ...
          className="w-full py-3.5 bg-[var(--cta-bg)] hover:bg-[#d94d24] text-white border-none rounded-lg text-sm font-semibold cursor-pointer transition-colors"
        >
          Begin Exam
        </button>
      </div>
  ...
  if (phase === "gate") {
    return (
      <div className="p-8 max-w-[720px] mx-auto bg-[var(--card-bg)] rounded-2xl border border-[var(--card-border)] text-[var(--foreground)] text-center">
        <div className="w-14 h-14 mx-auto mb-5 rounded-full bg-[var(--cta-bg)] flex items-center justify-center">
        ...
        <form onSubmit={handleUnlock} className="flex flex-col sm:flex-row gap-3 max-w-md mx-auto">
          <input
            ...
            className="flex-1 px-5 py-4 border border-[var(--card-border)] rounded-full bg-[var(--background)] text-[var(--foreground)] focus:outline-none focus:border-[var(--accent)] disabled:opacity-50"
          />
          <button
            type="submit"
            disabled={isSubmitting}
            className="bg-[var(--cta-bg)] text-white px-8 py-4 rounded-full font-medium hover:bg-[#d94d25] transition-colors disabled:opacity-50"
          >
                ...
                <button
                  ...
                  className={`text-[11px] px-2.5 py-1 rounded border cursor-pointer transition-colors ${
                    reviewFilter === f && showReview
                      ? "border-[var(--accent)] bg-[var(--cta-bg)]/10 text-[var(--accent)] font-semibold"
      ...
      <div className="sticky top-0 z-10 bg-[var(--card-bg)] border-b border-[var(--card-border)] px-6 py-2.5 flex items-center gap-3 rounded-t-2xl">
        <div className="flex-1">
          ...
          <div className="h-1 rounded-full bg-[var(--gray-200)] overflow-hidden">
            <div
              className="h-full rounded-full bg-[var(--cta-bg)] transition-all duration-200"
      ...
      <div className="px-6 pt-4">
        ...
        <div className="border border-[var(--card-border)] rounded-lg p-3 mb-3 text-xs text-[var(--gray-600)] leading-relaxed">
          <div className="flex justify-between items-center" style={{ marginBottom: showCtx ? "6px" : 0 }}>
            ...
            <button
              ...
              className="text-[11px] border-none bg-transparent cursor-pointer text-[var(--gray-600)] p-0 hover:text-[var(--accent)] transition-colors"
            >
        ...
        <div className="border border-[var(--card-border)] rounded-xl p-5 mb-3">
          ...
          {currentQ.options.map((opt, i) => {
            ...
            return (
              ...
              >
                <span className={`font-bold min-w-[16px] shrink-0 ${selected ? "text-[var(--accent)]" : "text-[var(--gray-600)]"}`}>
            ...
            return (
              <button
                ...
                className={`w-7 h-7 rounded text-[11px] cursor-pointer border transition-colors ${
                  isCurrent
                    ? "bg-[var(--cta-bg)] border-[var(--accent)] text-white font-bold"
                    : isFlag
        ...
        <div className="flex gap-2">
          ...
          {isLast ? (
            <button
              onClick={submitExam}
              className="flex-1 py-2.5 rounded-lg border-none bg-[var(--cta-bg)] hover:bg-[#d94d24] text-white cursor-pointer text-[13px] font-semibold transition-colors"
            >
              Submit exam
            </button>
          ) : (
