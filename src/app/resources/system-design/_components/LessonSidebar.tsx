            ...
            {course.modules.map((module) => (
              <div key={module.id} className="border border-[var(--card-border)] rounded-xl overflow-hidden hover:border-[#ffe500] transition-colors">
                <button
                  ...
                  className={`w-full text-left p-4 flex items-center justify-between hover:bg-[var(--gray-100)] transition-colors ${
                      ...
                      >
                        {lesson.free || hasAccess ? (
                          isCompleted(lesson.slug) ? (
                            ...
                            <div className="w-6 h-6 rounded-full border-2 border-[var(--gray-200)] flex items-center justify-center flex-shrink-0">
