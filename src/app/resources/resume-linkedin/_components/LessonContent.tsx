...
export default function LessonContent({
  ...
  const handleUnlock = async (e: React.FormEvent) => {
    ...
    await subscribe(email, {
      tags: ["bfewebsite", "course-signup", "resume-linkedin-guide"],
      onSuccess: () => {
    ...
    return (
      <div className="flex-1 min-w-0">
        ...
        <div className="mt-12 flex items-center justify-between pt-8 border-t border-[var(--card-border)]">
          {prevLesson ? (
            <Link
              href={`/resources/resume-linkedin/${prevLesson.slug}`}
          ...
          {nextLesson ? (
            <Link
              href={`/resources/resume-linkedin/${nextLesson.slug}`}
              className="flex items-center gap-2 text-[var(--gray-600)] hover:text-[var(--accent)] transition-colors"
            >
    ...
    <div className="flex-1 min-w-0">
      ...
      {hasContent ? (
                ...
                <div className="text-[var(--gray-600)] leading-relaxed">
                  <ReactMarkdown
                    components={{
                      ...
                      pre: ({ children }) => (
                        <pre className="bg-[var(--gray-100)] p-4 rounded-lg overflow-x-auto my-4 text-sm">
                          {children}
                        </pre>
                      ),
                      ul: ({ children }) => (
          ...
          <div className="mt-8 p-6 bg-[var(--gray-50)] rounded-2xl">
            {isSignedIn ? (
              ...
              <div className="text-center">
                ...
                <Link
                  href={`/auth/signin?callbackUrl=/resources/resume-linkedin/${lesson.slug}`}
        ...
        <div className="text-center py-16">
          ...
          <Link
            href="/resources/resume-linkedin"
