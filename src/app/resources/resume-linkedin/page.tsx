...
export const metadata = {
  title: "Resume & LinkedIn | The Black Female Engineer",
  description:
    "Land interviews at top tech companies. Learn how to craft ATS-optimized resumes, build a standout LinkedIn profile, and network effectively with recruiters.",
};

export default function ResumeLinkedInPage() {
  const course = getCourse("resume-linkedin");
  if (!course) notFound();
  ...
  return (
    <>
      ...
      <main className="pt-28 md:pt-32">
        {/* Hero */}
        <section className="bg-gradient-to-b from-blue-50 to-white py-12 md:py-16 border-b border-gray-100">
          <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
            ...
            <div className="grid lg:grid-cols-3 gap-8 items-start">
              <div className="lg:col-span-2">
                <span className="inline-block text-xs px-3 py-1 rounded-full font-medium bg-blue-100 text-blue-800 mb-4">
                  {course.tag}
                </span>
              ...
              <div className="bg-white rounded-2xl border border-gray-200 p-6 shadow-sm">
                ...
                {firstLesson && (
                  <Link
                    href={`/resources/resume-linkedin/${firstLesson.slug}`}
                ...
                <div className="space-y-6">
                  {course.modules.map((module) => (
                    ...
                    >
                      ...
                      <ModuleLessons module={module} coursePath="/resources/resume-linkedin" courseId="resume-linkedin" />
                    </div>
                  ))}
                </div>
              </div>
        ...
        <section className="bg-gray-50 py-16 md:py-24 border-t border-gray-100">
          <div className="max-w-2xl mx-auto px-4 sm:px-6 lg:px-8 text-center">
            ...
            <p className="text-gray-600 mb-8">
              ...
              for crafting your resume and optimizing your LinkedIn. Just enter your email to continue.
            </p>
